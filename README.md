...
```
$> cd bin
$> sudo php mix-httpd start -c ../applications/http/config/httpd.php -d      生产 启动
$> sudo php mix-httpd start -c ../applications/http/config/httpd.php -d -u   开发 热更新
$> sudo php mix-httpd stop -c ../applications/http/config/httpd.php          开发 命令行关闭  服务自动关闭
```
